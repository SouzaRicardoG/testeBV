...
LOAD DATA INPATH '/user/hive/ricardo_g_souza/bill_of_materials.csv' OVERWRITE INTO TABLE BILL_OF_MATERIALS;
...
LOAD DATA INPATH '/user/hive/ricardo_g_souza/comp_boss.csv' OVERWRITE INTO TABLE COMP_BOSS;
...
LOAD DATA INPATH '/user/hive/ricardo_g_souza/price_quote.csv' OVERWRITE INTO TABLE PRICE_QUOTE;
